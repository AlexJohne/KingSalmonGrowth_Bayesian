...
The model parameters have been estimated by the code `GrowthFit_Predictions_5.Rmd`. Here we present the parameter estimates and the intake and growth predictions according to the fitted model.
